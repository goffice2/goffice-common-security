 ...
 *
 * <p>
 * The <code>GofficeApiSecurityEnabled</code> class
 * </p>
 * <p>
 * Data: 29 apr 2022
 * </p>
...
@ComponentScan(basePackageClasses = { //
		...
		GofficeTenantService.class, //
		MultiTenantInterceptor.class, //
		LanguageInterceptor.class, //
		ThreadLocalLanguageStorage.class, //
		OpenTracingInterceptor.class, //
		ThreadLocalOpenTracingStorage.class, //
		TenantConfigurator.class, //
...
public @interface GofficeApiSecurityEnabled {
}